...
if (isset($_POST["submit"])) {
   ...
   foreach($notes->childNodes as $note) {
      ...
      if ($noteReceiverNode->nodeValue==$_POST["receiver"]) { //get the match of the post request
		  ...
		  echo "<h1>Receiver: ".$noteReceiverNode->nodeValue."</h1>";
		  echo "<table>";
   ...
   if ($notesFound==0) {
	  ...
	  echo "<tr><td style='text-align: center'>Receiver: ".$_POST['receiver']."</td></tr>";
	  echo "</table>";
	  echo "<a href='preNoteSearch.php'><img id='backBtn' src='back.png'></a>";
	  echo "</div>";
	  echo "</center>";
