...
if (isset($_POST["submit"])) {
   ...
   foreach($notes->childNodes as $note) {
      ...
      if ($noteIDNode==$_POST["id"]) { //get the match of the post request
...
<div id="container">
<h1>Note Search</h1>
<form method="post" action="idSearch.php">
  <table>
  <tr><td style="width:100px">ID: </td><td style="width:100px"><input type="text" name="id" required></td></tr>
